...
| coordinate_exact_ratio | P2 | PASS | 0.45453 | —（信息性断言） | SIMS_PROJECTION=EXACT 占 45.45%→ <100%，<1 km 环有系统性失真，须同时产出合并环敏感性结果 |
...
| 严重度 | 事项 | 证据 | 建议动作 |
| --- | --- | --- | --- |
| P2 | 坐标存在插值 | EXACT 占 45.45% | <1 km 环结果只作参考，主表用 5 km 中等环并始终给出合并环敏感性 |
