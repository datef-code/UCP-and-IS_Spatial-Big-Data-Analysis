# ④ 校验报告 · snap_brightkite

> 生成时间：2026-09-06T20:55:26　断言口径：`config/assertions.yaml`
...
| rows_after_clean | P0 | PASS | 4747172 | >= 1 |  |
| value_non_negative | P1 | PASS | 0 | 0 | 字段 value 负值 0 个 |
| version_lock_reproducible | P1 | PASS | 一致 | version_lock.json 中的库版本与本次运行一致 | 教学代码随版本冻结，版本漂移须重新出图 |
