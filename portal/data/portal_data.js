...
window.SDP_DATA = {
  ...
  "datakit": {
    "_src": {
      "from": "datakit/datakit",
      "note": "源码目录实测（行数 / 测试函数计数）"
    },
    "version": null,
    "module_count": 13,
    "src_lines": 2861,
  ...
  "impact": {
    "_src": {
      "from": "project1_fdic_spatial/06_estimate/output/estimate.json",
      "note": "估计阶段权威产物 + logs/stage_summaries.json"
    },
    "stages": [
      {
        "stage": "01_discover",
      ...
      },
      {
        ...
        "metrics": {
          ...
          "branches": 152538,
          "h3_cells": 70109,
          "closure_events": 27018,
          "event_type_dist": {
            "alive_censored": 76097,
            "attrition_missing": 46828,
            "closed_ma": 29613
          }
        }
      },
      {
        ...
        "blocking": false,
        "metrics": {
          "twfe_post": -0.05259387020663611,
          "twfe_post_x_strength": 0.013823280070386227,
          "twfe_p": 0.0,
          "event_study_tau0": -0.04379581109171783,
          "resid_moran_p": 0.001
        }
      },
      {
    ...
    "stage_seconds_total": 301.2,
    "stage_count": 9,
    "twfe": {
      "n_obs": 955025,
      "n_entities": 73324,
      "n_times": 31,
      "post": -0.05259387020663611,
      "post_se": 0.0016430377821804692,
      "post_p": 0.0,
      "post_x_strength": 0.013823280070386227,
      "post_x_strength_se": 0.00171193124972214,
      "post_x_strength_p": 6.661338147750939e-16,
      "r2_within": 0.003054444836813941
    },
    "event_study": {
      "baseline": -1,
      "n_obs": 955025,
      "n_treated_rows": 207727,
      "n_entities": 73324,
      "pre_trend_max_abs_t": 4.12175935426111,
      "table": [
        {
          "tau": -3,
          "effect": -0.0018907193923828345,
          "se": 0.0019443290870724658,
          "p": 0.3308410427744116
        },
        {
          "tau": -2,
          "effect": -0.006881715596122951,
          "se": 0.0016696063512316834,
          "p": 3.764027190666229e-05
        },
        {
          "tau": -1,
          "effect": 0.0,
        ...
        {
          "tau": 0,
          "effect": -0.04379581109171783,
          "se": 0.0012692187847814773,
          "p": 7.813392542674715e-259
        },
        {
          "tau": 1,
          "effect": -0.043035792452816204,
          "se": 0.0011502147790718733,
          "p": 1.6236224758789194e-303
        },
        {
          "tau": 2,
          "effect": -0.07359545055442644,
          "se": 0.0011666038506011971,
          "p": 0.0
        },
        {
          "tau": 3,
          "effect": -0.08929199316782027,
          "se": 0.0012087253324875456,
          "p": 0.0
        },
        {
          "tau": 4,
          "effect": -0.10067675352931099,
          "se": 0.0012236098602472526,
          "p": 0.0
        }
      ]
    },
    "spatial": {
      "n": 30000,
      "ols": {
        "treat": 0.0073134452273349556,
        "treat_se": 0.0009998789481819076,
        "r2": 0.030907900203911765,
        "lm_lag_stat": 38.952966415642166,
        "lm_lag_p": 4.3414005723718674e-10,
        "lm_error_stat": 0.001489705199414718,
        "lm_error_p": 0.9692119338841989,
        "robust_lm_lag_p": 0.7784639911305359,
        "robust_lm_error_p": 0.7784639911305359
      },
      "slx": {
        "direct": -0.005888076428926709,
        "direct_se": 0.002636713053138217,
        "direct_p": 0.02554888479513136,
        "spillover": 0.008986047028245209,
        "spillover_se": 0.0027869748018758533,
        "spillover_p": 0.0012641548429567222,
        "r2": 0.036965526108280744
      },
      "sar": {
        "rho": -0.1701324779388358,
        "rho_se": 0.10161862080993174,
        "r2": 0.010842341616878477,
        "logll_is_nan": true
      },
      "sem": {
        "lambda": 0.2001239956801025,
        "lambda_se": 0.0012576983524497903,
        "r2": 0.030841943327971147
      },
      "resid_moran": {
        "I": 0.07032862790689301,
        "E_I": -3.333444448148272e-05,
        "Var_I": 9.630505125924428e-06,
        "z_sim": 23.344368670577172,
        "p_sim": 0.001,
      ...
      "decomposition": {
        ...
        "sar_approx": {
          "rho": -0.1701324779388358,
          "b_treat_strength": 0.007885929125981073,
          "direct_effect": 0.006739347274482949,
          "spillover_effect": -0.0009798735383516606,
          "total_effect": 0.005759473736131289,
          "spillover_share": -0.1701324779388358,
          "note": "SAR 含 W·Y 不含 W·X；一阶近似"
        },
        "sem": {
          "lambda": 0.2001239956801025,
          "b_treat_strength": 0.007130871659819751,
          "note": "SEM 空间结构只在残差；direct = β_treat",
          "direct_effect": 0.007130871659819751,
          "spillover_effect": 0.0,
          "total_effect": 0.007130871659819751
        }
      }
    },
    "coordinate_precision": {
      ...
      "explanation": "SIMS_PROJECTION 取值词表 2023 年切换，不可跨年代直接比较；早年多为插值坐标 → <1 km 距离环存在系统性失真；主表用 5 km 中等环。旧口径『EXACT 占 45.45%』已作废（混淆编码切换与样本退出时间）",
      "supersedes": "EXACT_pct_45.45"
    },
    "rings": {
      "fine": [
        "0_1",
    ...
    "ols_cell": {
      ...
      "terms": [
        {
          "name": "const",
          "coef": 0.5634393787680855,
          "se": 0.01384165069084557
        },
        {
          "name": "treat_strength",
          "coef": 0.0073134452273349556,
          "se": 0.0009998789481819076
        },
        {
          "name": "log_dep_t0",
          "coef": -0.04242659547835196,
          "se": 0.0013849202357805622
        },
        {
          "name": "n_branches",
          "coef": 0.019860949870729252,
          "se": 0.001249563121447181
        }
      ]
    },
    "sensitivity_audit": {
    ...
    "metrics_flat": {
      ...
      "event_study": {
        ...
        "pre_trend_max_abs_t": 4.12175935426111,
        "effects": {
          "-3": -0.0018907193923828345,
          "-2": -0.006881715596122951,
          "-1": 0.0,
          "0": -0.04379581109171783,
          "1": -0.043035792452816204,
          "2": -0.07359545055442644,
          "3": -0.08929199316782027,
          "4": -0.10067675352931099
        }
      },
      "spatial": {
        "chosen": "ols",
        "residuals_morans_i": 0.07032862790689301,
        "residuals_morans_p_sim": 0.001,
        "slx_w_treat_strength": 0.008986047028245209,
        "sar_rho": -0.1701324779388358,
        "sem_lambda": 0.2001239956801025
      },
  ...
  "risk": {
    "_src": {
      "from": "project2_fdic_survival/06_train/output/metrics.json",
      "note": "训练阶段权威产物 + replication_manifest + cloglog_summary.txt"
    },
    "stages": [
      {
        "stage": "01_discover",
    ...
    "panel": {
      "rows": 1667283,
      "branches": 140751,
      "event_rate": 0.041329516344855675,
      "year_range": [
        1994,
        2025
      ]
    ...
    "params": {
      "random_state": 42,
      "max_total_sample": 500000,
      "shap_sample_n": 2000,
      "moran_k": 8,
      "moran_n_perm": 199,
      "c_index_max_n": 120000,
    ...
    "cloglog": {
      ...
      "coefficients": [
        ...
        {
          "name": "C(fragility_tier)[T.L1_多网点高集中]",
          "kind": "fragility",
          "level": "L1_多网点高集中",
          "coef": 0.3197,
          "se": 0.026,
        ...
        {
          "name": "C(fragility_tier)[T.L2_多网点地理分散]",
          "kind": "fragility",
          "level": "L2_多网点地理分散",
          "coef": 0.4708,
          "se": 0.025,
        ...
        {
          "name": "bank_closed_rate",
          "kind": "numeric",
          "level": "bank_closed_rate",
          "coef": 3.8156,
          "se": 0.022,
          "p": 0.0,
          "lo": 3.773,
    ...
    "shap_force": {
      "model": "logit_discrete_time（主模型）",
      "base_value": -4.1643088214446955,
      "examples": [
        {
          "label": "高风险 · 已关闭",
          "predicted_risk": "82.71%",
          "shap": {
            "网点年龄": 0.000249,
            "存款规模（对数）": 0.666302,
            "同格网点数（竞争强度）": -0.014354,
    ...
    "model_card": {
      ...
      "test_event_rate": 0.13782,
      "panel_event_rate": 0.041329516344855675,
    ...
    "ranges": {
      "DEPSUMBR": {
        "min": 0.0,
        "max": 727192402.0,
        "mean": 100930.74554096615,
        "median": 35899.0,
        "std": 2024473.6500673264,
        "null_rate": 0.0
      },
      "SIMS_LATITUDE": {
        "min": -35.25960006,
        "max": 158.227518485,
        "mean": 37.913290559587146,
        "median": 39.039821,
        "std": 5.212519660199828,
        "null_rate": 0.080387
      },
      "SIMS_LONGITUDE": {
        "min": -170.71861,
        "max": 174.12399994,
        "mean": -90.0180520933612,
        "median": -86.689238,
        "std": 14.992692824522546,
        "null_rate": 0.08039
      }
    },
    "feature_spec": {
  ...
  "teaching": {
    "_src": {
      "from": "project6_spatial_teaching/05_map/output",
      "note": "四数据集 ladder_report.json（L0→L3 实测）"
    },
    "stages": [
      {
        "stage": "01_discover",
      ...
      },
      {
        ...
        "metrics": {
          "datasets": {
            "fdic": 152538,
            "sz_bike": 8572465,
            "snap_brightkite": 4747287,
            "snap_gowalla": 6442892
          },
          "rows": 19915182,
          "violations": 7
        }
      },
      {
        ...
        "blocking": true,
        "metrics": {
          "rows_before": 19915182,
          "rows_after": 19910637,
          "removed_rate": 0.000228,
          "datasets": {
            "fdic": 148137,
            "sz_bike": 8572465,
            "snap_brightkite": 4747172,
            "snap_gowalla": 6442863
          }
        }
      },
      {
    ...
    "datasets": [
      {
        ...
        "cells": 70456,
        "h3_res": 8,
        "mean_neighbors": 1.4129953446122403,
        "islands": 19786,
        "moran_i": 0.13310910409030818,
        "lag_corr": 0.2163049845145565,
        "spill_sum_by_ring": {
          "spill_0_1km": 42.26,
          "spill_1_3km": 31.57,
          "spill_3_5km": 42.45,
        ...
        "spill_density_by_ring": {
          "spillden_0_1km": 7.617238095238094,
          "spillden_1_3km": 2.127605048771719,
          "spillden_3_5km": 1.7181010165440551,
          "spillden_5_10km": 1.6415240880388995
        },
      ...
      },
      {
        ...
        "cells": 2661,
        "h3_res": 8,
        "mean_neighbors": 5.06651634723788,
        "islands": 121,
        "moran_i": 0.7076865029059817,
        "lag_corr": 0.8581371081924403,
        "spill_sum_by_ring": {
          "spill_0_1km": 171725.05,
          "spill_1_3km": 441272.86,
          "spill_3_5km": 604740.18,
          "spill_5_10km": 1421334.86
        },
        "spill_density_by_ring": {
          "spillden_0_1km": 24612.434761904762,
          "spillden_1_3km": 15870.472887629845,
          "spillden_3_5km": 10056.02433652752,
          "spillden_5_10km": 6866.730795993034
        },
        "note": "环内格数随距离增加，求和口径不衰减；按环内格均摊（溢出密度）才反映距离衰减——聚合口径影响结论，对应 L1→L2→L3 认知阶梯"
      },
      {
        "dataset": "snap_brightkite",
        "points": 4747172,
        "cells": 228476,
        "h3_res": 8,
        "mean_neighbors": 2.014942488488944,
        "islands": 67189,
        "moran_i": 0.013182832844203757,
        "lag_corr": 0.026615620525113605,
        "spill_sum_by_ring": {
          "spill_0_1km": 12442.34,
          "spill_1_3km": 9361.73,
          "spill_3_5km": 8625.29,
          "spill_5_10km": 14592.37
        },
        "spill_density_by_ring": {
          "spillden_0_1km": 3006.3924285714284,
          "spillden_1_3km": 341.92463211144405,
          "spillden_3_5km": 147.87157284375158,
          "spillden_5_10km": 65.31963056103085
        },
        "note": "环内格数随距离增加，求和口径不衰减；按环内格均摊（溢出密度）才反映距离衰减——聚合口径影响结论，对应 L1→L2→L3 认知阶梯"
      },
      {
        "dataset": "snap_gowalla",
        "points": 6442863,
        "cells": 302580,
        "h3_res": 8,
        "mean_neighbors": 2.4044682398043493,
        "islands": 66069,
        "moran_i": 0.5090157876067666,
        "lag_corr": 0.7245589234326157,
        "spill_sum_by_ring": {
          "spill_0_1km": 27872.73,
          "spill_1_3km": 52203.25,
          "spill_3_5km": 29896.4,
          "spill_5_10km": 30652.12
        },
        "spill_density_by_ring": {
          "spillden_0_1km": 4023.5096904761904,
          "spillden_1_3km": 1459.5723929374997,
          "spillden_3_5km": 457.5540670712734,
          "spillden_5_10km": 123.52327173845288
        },
        "note": "环内格数随距离增加，求和口径不衰减；按环内格均摊（溢出密度）才反映距离衰减——聚合口径影响结论，对应 L1→L2→L3 认知阶梯"
      }
    ]
